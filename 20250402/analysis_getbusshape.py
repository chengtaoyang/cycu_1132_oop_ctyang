...
try:
    # 讀取 JSON 檔案
    with open("data/GetBusShape", "r", encoding="utf-8") as file:
        content = file.read()
    ...
    # 儲存為 GeoJSON 檔案
    gdf.to_file("data/taipei_city_bus_route.geojson", driver="GeoJSON")

    # 儲存為 gpkg 檔案
    gdf.to_file("data/taipei_city_bus_route.gpkg", driver="GPKG")
    ...
    # Save to HTML
    m.save("data/teipei_city_bus_routes_map.html")
